...
$(document).ready(function() {
  function makeTimer() {
    var endTime = new Date("aug 15, 2022 02:15:13");
...
$(document).ready(function () {
    function makeTimer() {
        var endTime = new Date("aug 18, 2022 06:10:28");
        var endTime = (Date.parse(endTime)) / 1000;
        var now = new Date();
        var now = (Date.parse(now) / 1000);
        var timeLeft = endTime - now;
...
$(document).ready(function () {
    function makeTimer() {
        var endTime = new Date("aug 21, 2022 09:18:23");
        var endTime = (Date.parse(endTime)) / 1000;
        var now = new Date();
        var now = (Date.parse(now) / 1000);
        var timeLeft = endTime - now;
...
$(document).ready(function () {
  function makeTimer() {
      var endTime = new Date("aug 22, 2022 07:13:18");
      var endTime = (Date.parse(endTime)) / 1000;
      var now = new Date();
      var now = (Date.parse(now) / 1000);
      var timeLeft = endTime - now;
...
$(document).ready(function () {
  function makeTimer() {
      var endTime = new Date("aug 20, 2022 11:35:47");
      var endTime = (Date.parse(endTime)) / 1000;
      var now = new Date();
      var now = (Date.parse(now) / 1000);
      var timeLeft = endTime - now;
